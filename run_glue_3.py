...
""" Finetuning the library models for sequence classification on GLUE (Bert, XLM, XLNet, RoBERTa).
    Distributed training with gradient synchronization via all_reduce (Part 2b).
"""
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.fp16:
                ...
                # -----------------------------------------------------------
                # Part 3: DDP handles gradient sync automatically -- no manual call needed.
...
def main():
    ...
    # ------------------------------------------------------------------
    # Part 3: Wrap model with DistributedDataParallel.
    # DDP automatically handles gradient synchronization (all-reduce)
    # after every backward pass -- no manual synchronize_gradients needed.
    # ------------------------------------------------------------------
    if args.world_size > 1:
